...
import static frc.robot.Constants.PhysicalConstants.DRIVE_KINEMATICS;
...
public class AutoCommands {
    public static Command simpleAuto(DriveSubsystem robotDrive) {
        ...
        PIDController velocityFLController = new PIDController(P_FRONT_LEFT_VEL, 0, 0);
        PIDController velocityBLController = new PIDController(P_REAR_LEFT_VEL, 0, 0);
        PIDController velocityFRController = new PIDController(P_FRONT_RIGHT_VEL, 0, 0);
        PIDController velocityBRController = new PIDController(P_REAR_RIGHT_VEL, 0, 0);
